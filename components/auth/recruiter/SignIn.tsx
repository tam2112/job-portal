...
import { loginSchema, LoginSchema } from '@/lib/validation/company.form';
import { signInCompany } from '@/lib/actions/company.action';
...
export default function SignIn() {
    ...
    const onSubmit = handleSubmit(async (data) => {
        const response = await signInCompany(state, data);
        ...
        <div className="flex justify-center items-center pt-28">
            <form onSubmit={onSubmit} className="relative bg-slate-100 shadow p-10 rounded-xl text-slate-500">
                ...
                <p className="mt-5 text-center">
                    ...
                    <Link href={'/recruiter/sign-up'} className="text-blue-600 cursor-pointer">
                        Sign Up
                    </Link>
                </p>
            </form>
