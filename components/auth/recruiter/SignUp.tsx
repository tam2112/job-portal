...
import { signUpSchema, SignUpSchema } from '@/lib/validation/company.form';
import { signUpCompany } from '@/lib/actions/company.action';
...
export default function SignUp() {
    ...
    const [state, formAction] = useFormState(signUpCompany, {
        success: false,
        error: false,
    });
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        const dataWithImageUrls = { ...data, imageUrls };
        ...
        <div className="flex justify-center items-center pt-28">
            <form onSubmit={onSubmit} className="relative bg-slate-100 p-10 rounded-xl text-slate-500">
                    ...
                    <div className="flex items-center gap-4 my-2">
                        <label htmlFor="image" className="flex items-center gap-4">
                            <div className="bg-white size-16 rounded-full flex items-center justify-center">
                                <Image
                                    src={images.length > 0 ? previewUrl : assets.upload_area}
                                    alt="upload area"
                                    width={48}
                                    height={48}
                ...
                <p className="mt-5 text-center">
                    ...
                    <Link href={'/recruiter/sign-in'} className="text-blue-600 cursor-pointer">
                        Login
                    </Link>
                </p>
            </form>
