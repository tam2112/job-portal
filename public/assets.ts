...
export const manageJobsData = [
    { id: 1, title: 'Full Stack Developer', date: 1729102298497, location: 'Bangalore', applicants: 20 },
    { id: 2, title: 'Data Scientist', date: 1729102298497, location: 'San Francisco', applicants: 15 },
    { id: 3, title: 'Marketing Manager', date: 1729102298497, location: 'London', applicants: 2 },
    { id: 4, title: 'UI/UX Designer', date: 1729102298497, location: 'Dubai', applicants: 25 },
];
...
export const viewApplicationsPageData = [
    { id: 1, name: 'Richard Sanford', jobTitle: 'Full Stack Developer', location: 'Bangalore', imgSrc: profile_img },
    { id: 2, name: 'Enrique Murphy', jobTitle: 'Data Scientist', location: 'San Francisco', imgSrc: profile_img },
    { id: 3, name: 'Alison Powell', jobTitle: 'Marketing Manager', location: 'London', imgSrc: profile_img },
    { id: 4, name: 'Richard Sanford', jobTitle: 'UI/UX Designer', location: 'Dubai', imgSrc: profile_img },
    { id: 5, name: 'Enrique Murphy', jobTitle: 'Full Stack Developer', location: 'Hyderabad', imgSrc: profile_img },
    { id: 6, name: 'Alison Powell', jobTitle: 'Data Scientist', location: 'New Delhi', imgSrc: profile_img },
    { id: 7, name: 'Richard Sanford', jobTitle: 'Marketing Manager', location: 'Chennai', imgSrc: profile_img },
];
...
export const sidebarLinks = [
    { id: 1, label: 'Add Job', path: '/dashboard/add-job', image: assets.add_icon },
    { id: 2, label: 'Manage Job', path: '/dashboard/manage-job', image: assets.home_icon },
    { id: 3, label: 'View Applications', path: '/dashboard/view-applications', image: assets.person_tick_icon },
];
